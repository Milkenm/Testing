...
using Testing.Riot_API.Resources;
...
namespace Testing.RiotAPI
{
	public partial class RiotAPITesting : Form
	{
		...
		private string sumInfo = "https://euw1.api.riotgames.com/lol/summoner/v4/summoners/by-name/{0}?api_key={1}";
		private string masteryInfo = "https://euw1.api.riotgames.com/lol/champion-mastery/v4/champion-masteries/by-summoner/{0}?api_key={1}";





		public RiotAPITesting()
		{
			InitializeComponent();
		}
		...
		private void RiotAPITesting_FormClosing(object sender, FormClosingEventArgs e)
		{
			set.Save();
		}
		...
		{
			set.ApiKey = textBox_apiKey.Text;
		}
		...
		private void button_get_Click(object sender, EventArgs e)
		{
			...
			{
				MessageBox.Show("Esse Summoner não foi encontrado.");
			}
		}
