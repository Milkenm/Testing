...
namespace Testing.RiotAPI
{
	public partial class RiotAPITesting : Form
	{
		...
		string url = "https://euw1.api.riotgames.com/lol/summoner/v4/summoners/by-name/{0}?api_key={1}";

		public RiotAPITesting() => InitializeComponent();
		private void RiotAPI_Load(object sender, EventArgs e) => textBox_apiKey.Text = set.ApiKey;
		...
		string FormatString()
		{
			return string.Format(url, textBox_summoner.Text, textBox_apiKey.Text);
		}
